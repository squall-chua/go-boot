...
// The service go-boot's own gRPC tests mount. It is not shipped to users and
// it is not importable: internal/gen is inside internal/. The Scaffold writes
// a proto of the same shape into a new project.
...
const file_greet_v1_greet_proto_rawDesc = "" +
	...
	"\bgreeting\x18\x01 \x01(\tR\bgreeting2\x9a\x01\n" +
	"\fGreetService\x12:\n" +
	"\x05Greet\x12\x16.greet.v1.GreetRequest\x1a\x17.greet.v1.GreetResponse\"\x00\x12N\n" +
	"\vGreetStream\x12\x1c.greet.v1.GreetStreamRequest\x1a\x1d.greet.v1.GreetStreamResponse\"\x000\x01B>Z<github.com/squall-chua/go-boot/internal/gen/greet/v1;greetv1b\x06proto3"

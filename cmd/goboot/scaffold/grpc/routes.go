...
import (
	...
	greetingentity "github.com/squall-chua/go-boot/cmd/goboot/scaffold/grpc/internal/greeting/entity"
	greetingrest "github.com/squall-chua/go-boot/cmd/goboot/scaffold/grpc/internal/greeting/rest"
	greetingrpc "github.com/squall-chua/go-boot/cmd/goboot/scaffold/grpc/internal/greeting/rpc"
)
...
func addRoutes(app *preset.App, cfg config) {
	...
	greetingrpc.Routes(app.Web, app.Log, greet)
}
